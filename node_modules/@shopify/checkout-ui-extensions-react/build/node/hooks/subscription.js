...
function useSubscription(subscription) {
  const [, setValue] = (0, _react.useState)(subscription.current);
  (0, _react.useEffect)(() => {
    ...
    const unsubscribe = subscription.subscribe(checkForUpdates); // Because we're subscribing in a passive effect,

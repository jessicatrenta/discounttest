...
function render(extensionPoint, render) {
    ...
    return (0, checkout_ui_extensions_1.extend)(extensionPoint, (root, api) => {
        return new Promise((resolve, reject) => {
            try {
                (0, react_1.render)((0, jsx_runtime_1.jsx)(context_1.ExtensionApiContext.Provider, Object.assign({ value: api }, { children: render(api) })), root, () => {
                    resolve();
                });
            }
            catch (error) {

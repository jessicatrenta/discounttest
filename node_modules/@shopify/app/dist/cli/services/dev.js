...
async function dev(options) {
    ...
    if ((frontendConfig || backendConfig) && options.update) {
        ...
        const shouldUpdate = await shouldOrPromptUpdateURLs({
            currentURLs,
    ...
    if (options.app.extensions.ui.length > 0) {
        const devExt = await devExtensionsTarget(options.app, apiKey, proxyUrl, storeFqdn, options.subscriptionProductUrl, options.checkoutCartUrl);

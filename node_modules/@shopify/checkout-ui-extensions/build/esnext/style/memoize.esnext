...
function createLruCache(maxSize, equals) {
  ...
  function get(key) {
    const cacheIndex = entries.findIndex(entry => equals(key, entry.key)); // We found a cached entry
...
export const defaultEqualityCheck = (first, second) => {
  return first === second;
};
...
export function memoize(func, equalityCheckOrOptions) {

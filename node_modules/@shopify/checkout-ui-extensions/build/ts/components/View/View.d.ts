...
import { BorderProps, SizingProps, SpacingProps, VisibilityProps } from '../shared';
import type { BlockAlignment, InlineAlignment, MultiPick, ViewLikeAccessibilityRole } from '../shared';
declare type AccessibilityVisibility = 'hidden';
declare type Display = 'block' | 'inline';
declare type Opacity = 10 | 20 | 30 | 40 | 50 | 60 | 70 | 80 | 90;
...
declare type PositionCoordinates = MultiPick<BaseCoordinates, [
...
export interface ViewProps extends BorderProps, SizingProps, SpacingProps, VisibilityProps {
     ...
     */
    blockAlignment?: MaybeConditionalStyle<Extract<BlockAlignment, 'start' | 'center' | 'end'>>;
    /**

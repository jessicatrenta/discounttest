...
describe('isEqual', () => {
    it('returns true when two strings are equal', () => {
        expect((0, isEqual_1.isEqual)('a', 'a')).toBe(true);
    });
    it('returns true when two numbers are equal', () => {
        expect((0, isEqual_1.isEqual)(1, 1)).toBe(true);
    });
    it('returns true when two booleans are equal', () => {
        expect((0, isEqual_1.isEqual)(true, true)).toBe(true);
    });
    it('returns true when two objects are equal', () => {
        expect((0, isEqual_1.isEqual)({
            string: 'string',
            number: 1,
            boolean: true,
        }, {
    ...
    it('returns true when two arrays are equal', () => {
        expect((0, isEqual_1.isEqual)([1, 'a', true], [1, 'a', true])).toBe(true);
    });
    it('returns true when two nested arrays are equal', () => {
        expect((0, isEqual_1.isEqual)([1, [2, 'b', false], 'a', true], [1, [2, 'b', false], 'a', true])).toBe(true);
    });
});

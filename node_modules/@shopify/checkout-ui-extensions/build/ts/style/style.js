...
exports.isConditionalStyle = exports.Style = void 0;
const memoize_1 = require("./memoize");
const isEqual_1 = require("./isEqual");
const MAX_CACHE_SIZE = 50;
const MEMOIZE_OPTIONS = {
    equalityCheck: isEqual_1.isEqual,
...
exports.Style = {
     ...
     */
    default: (0, memoize_1.memoize)((defaultValue) => createChainableConditionalStyle({
     ...
     * @returns The chainable condition style
     */
    when: (0, memoize_1.memoize)(when, MEMOIZE_OPTIONS),
};
...
function createChainableConditionalStyle(conditionalStyle) {
    ...
    proto.when = (0, memoize_1.memoize)(when.bind(returnConditionalStyle), MEMOIZE_OPTIONS);
